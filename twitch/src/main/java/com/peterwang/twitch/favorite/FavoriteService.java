package com.peterwang.twitch.favorite;

import com.peterwang.twitch.db.FavoriteRecordRepository;
import com.peterwang.twitch.db.ItemRepository;
import com.peterwang.twitch.db.entity.FavoriteRecordEntity;
...
public class FavoriteService {
    ...
    //@Transactional is used to make sure the separate db operations would either be committed
